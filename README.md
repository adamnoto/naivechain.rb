...
a system, e.g.: how the system will work that is, it will work by involving a
Blockchain, Merkle tree, and so on. On the other hand, making a borderless transaction
